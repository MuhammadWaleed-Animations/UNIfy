...
@Composable
fun UserPageScreen(onNavigate: (String) -> Unit,userId:String , viewModel:UserProfileViewModel = hiltViewModel()) {
    // State to manage dialog visibility
    val userState by viewModel.userState.collectAsState()
    val guserState by viewModel.guserState.collectAsState() // gair user ha ye
    ...
    Box(
        ...
        if (userId != userState?.user?._id) {
            ...
            val pfp = when (guserState?.profilePicture) {
                "Cat 1" -> R.drawable.cat1
                "Cat 2" -> R.drawable.cat2
                "Cat 3" -> R.drawable.cat3
                "Cat 4" -> R.drawable.cat4
            ...
            UserProfileContent(
                guserState?.username?:"unknown",
                guserState?.contactInfo?:"unknown",
                //userId,
                guserState?.email?:"unknown",
                pfp,
